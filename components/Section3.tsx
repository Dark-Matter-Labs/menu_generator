        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full px-8">
          ...
          <div className="bg-gray-200/90 backdrop-blur-sm rounded-lg p-6 shadow-lg">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-serif text-[#382B20] font-semibold">Climatic Futures</h3>
            </div>
            <p className="text-[#382B20] mb-4 text-sm leading-relaxed">
              Different sections of the table experience distinct climatic realities, from regenerative abundance to extreme scarcity.
            </p>
            <div className="space-y-2">
              <p className="text-sm font-medium text-[#382B20] mb-2">Experience Elements:</p>
              <ul className="text-xs text-[#382B20] space-y-1">
                <li>I. Regenerative Scenario: Abundant, diverse, locally-sourced meals</li>
                <li>II. Business-as-Usual: Current systems with emerging constraints</li>
                <li>III. 4-Degree Extreme: Scarcity, substitutes, survival foods</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-gray-200/90 backdrop-blur-sm rounded-lg p-6 shadow-lg">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-serif text-[#382B20] font-semibold">Socio–economic Realities</h3>
            </div>
            <p className="text-[#382B20] mb-4 text-sm leading-relaxed">
              Experience how different communities within the same geography or city eat based on inequality and access.
            </p>
            <div className="space-y-2">
              <p className="text-sm font-medium text-[#382B20] mb-2">Explore:</p>
              <ul className="text-xs text-[#382B20] space-y-1">
          ...
          <div className="bg-gray-200/90 backdrop-blur-sm rounded-lg p-6 shadow-lg">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-serif text-red-500 font-semibold">Spatial Futures</h3>
            </div>
            <p className="text-[#382B20] mb-4 text-sm leading-relaxed">
