      ...
      <div className="w-full mx-10 bg-[#B3B0A4F5] rounded-t-full h-[200vh] flex flex-col items-start pt-80 justify-center">
        <div className="flex flex-row items-center justify-center gap-x-20 w-full mx-10">
          ...
          <div className="basis-1/2 font-roboto text-[#382B20] flex flex-col items-start justify-center">
            <div className="max-w-md">
              ...
              <p className="mb-4">
                Digesting the Future is an immersive dining event that allows
                one to experience how different possible, plausible, or
                preferable futures might taste, smell, feel, or sound.
              </p>
              <p className="mb-4">
                Each scenario, and each course invites us to reflect on the
                values and choices that shape current food systems, discuss
                where these may lead us to, and confront, often, uncomfortable
                futures.
              </p>
              <p>Anything from a </p>
        ...
        <div className="w-full px-20 mt-30 relative">
          ...
          <div className="absolute bottom-10 left-42 text-blue-200 z-10">
            <div className="text-3xl text-stone-600 font-serif font-bold">
              Brussels
            </div>
            <div className="text-sm">
              <span className="font-bold">Location:</span> Brussels
            </div>
            <div className="text-sm">
              <span className="font-bold">Modality:</span> Climate Futures
            </div>
            <div className="text-sm">
              <span className="font-bold">People:</span> 70
            </div>
          </div>
        </div>
      </div>
